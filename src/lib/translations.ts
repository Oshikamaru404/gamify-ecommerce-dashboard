...
export const translations = {
  en: {
    ...
    heroSubtitle: 'Stream thousands of channels and movies in stunning 4K quality. Experience entertainment like never before with our premium IPTV service.',
    ...
    whyChooseSubtitle: 'Experience the best in entertainment technology',
    ...
    // Missing keys for Home.tsx and IPTVPanel.tsx
    tryFree: 'Try Free',
    contact: 'Contact us',
    freeTrial: 'Free Trial',
    subscriptionsTitle: 'IPTV Subscription Packages',
    premiumQuality: 'Premium Quality',
    premiumQualityDesc: 'Crystal clear 4K streaming with no buffering',
    guaranteedReliability: 'Guaranteed Reliability',
    guaranteedReliabilityDesc: '99.9% uptime guarantee with 24/7 support',
    fastActivation: 'Fast Activation',
    fastActivationDesc: 'Instant activation within minutes of purchase',
    ctaTitle: 'Ready to Get Started?',
    ctaSubtitle: 'Join thousands of satisfied customers today',
    currency: '$',
    iptvPanelTitle: 'IPTV Panel Credits',
    iptvPanelSubtitle: 'Purchase credits to manage your IPTV subscriptions with our advanced panel system',
    manageSubscriptions: 'Credit Packages',
    perMonth: 'per month',
    buyNow: 'Buy Now',
    needHelp: 'Need Help?',
  },
  ...
  fr: {
    ...
    heroSubtitle: 'Diffusez des milliers de chaînes et de films en qualité 4K époustouflante. Vivez le divertissement comme jamais auparavant avec notre service IPTV premium.',
    ...
    whyChooseSubtitle: 'Découvrez le meilleur de la technologie de divertissement',
    ...
    subscriptionsTitle: 'Forfaits d\'Abonnement IPTV',
    premiumQuality: 'Qualité Premium',
    premiumQualityDesc: 'Streaming 4K cristallin sans mise en mémoire tampon',
    guaranteedReliability: 'Fiabilité Garantie',
    guaranteedReliabilityDesc: 'Garantie de disponibilité 99,9% avec support 24/7',
    fastActivation: 'Activation Rapide',
    fastActivationDesc: 'Activation instantanée en quelques minutes après l\'achat',
    ctaTitle: 'Prêt à Commencer?',
    ctaSubtitle: 'Rejoignez des milliers de clients satisfaits aujourd\'hui',
    currency: '€',
    iptvPanelTitle: 'Crédits Panel IPTV',
    iptvPanelSubtitle: 'Achetez des crédits pour gérer vos abonnements IPTV avec notre système de panneau avancé',
    manageSubscriptions: 'Forfaits de Crédits',
    perMonth: 'par mois',
  ...
  es: {
    ...
    heroSubtitle: 'Transmite miles de canales y películas en calidad 4K impresionante. Experimenta el entretenimiento como nunca antes con nuestro servicio IPTV premium.',
    getStarted: 'Comenzar',
    learnMore: 'Saber Más',
    ...
    whyChooseSubtitle: 'Experimenta lo mejor en tecnología de entretenimiento',
    ...
    subscriptionsTitle: 'Paquetes de Suscripción IPTV',
    premiumQuality: 'Calidad Premium',
    premiumQualityDesc: 'Streaming 4K cristalino sin buffering',
    guaranteedReliability: 'Confiabilidad Garantizada',
    guaranteedReliabilityDesc: 'Garantía de tiempo de actividad del 99.9% con soporte 24/7',
    fastActivation: 'Activación Rápida',
    fastActivationDesc: 'Activación instantánea en minutos después de la compra',
    ctaTitle: '¿Listo para Comenzar?',
    ctaSubtitle: 'Únete a miles de clientes satisfechos hoy',
    currency: '$',
    iptvPanelTitle: 'Créditos Panel IPTV',
    iptvPanelSubtitle: 'Compra créditos para gestionar tus suscripciones IPTV con nuestro sistema de panel avanzado',
    manageSubscriptions: 'Paquetes de Créditos',
    perMonth: 'por mes',
  ...
  de: {
    ...
    heroSubtitle: 'Streamen Sie Tausende von Kanälen und Filmen in atemberaubender 4K-Qualität. Erleben Sie Unterhaltung wie nie zuvor mit unserem Premium-IPTV-Service.',
    getStarted: 'Loslegen',
    ...
    whyChooseSubtitle: 'Erleben Sie das Beste in der Unterhaltungstechnologie',
    ...
    subscriptionsTitle: 'IPTV-Abonnement-Pakete',
    premiumQuality: 'Premium-Qualität',
    premiumQualityDesc: 'Kristallklares 4K-Streaming ohne Pufferung',
    guaranteedReliability: 'Garantierte Zuverlässigkeit',
    guaranteedReliabilityDesc: '99,9% Betriebszeit-Garantie mit 24/7-Support',
    fastActivation: 'Schnelle Aktivierung',
    fastActivationDesc: 'Sofortige Aktivierung innerhalb von Minuten nach dem Kauf',
    ctaTitle: 'Bereit Anzufangen?',
    ctaSubtitle: 'Werden Sie noch heute Teil von tausenden zufriedenen Kunden',
    currency: '€',
    iptvPanelTitle: 'IPTV Panel Credits',
    iptvPanelSubtitle: 'Kaufen Sie Credits zur Verwaltung Ihrer IPTV-Abonnements mit unserem erweiterten Panel-System',
    manageSubscriptions: 'Credit-Pakete',
    perMonth: 'pro Monat',
    buyNow: 'Jetzt Kaufen',
  ...
  it: {
    ...
    heroSubtitle: 'Guarda migliaia di canali e film in qualità 4K straordinaria. Vivi l\'intrattenimento come mai prima d\'ora con il nostro servizio IPTV premium.',
    getStarted: 'Inizia',
    ...
    whyChooseSubtitle: 'Vivi il meglio della tecnologia dell\'intrattenimento',
    ...
    subscriptionsTitle: 'Pacchetti di Abbonamento IPTV',
    premiumQuality: 'Qualità Premium',
    premiumQualityDesc: 'Streaming 4K cristallino senza buffering',
    guaranteedReliability: 'Affidabilità Garantita',
    guaranteedReliabilityDesc: 'Garanzia di uptime del 99.9% con supporto 24/7',
    fastActivation: 'Attivazione Veloce',
    fastActivationDesc: 'Attivazione istantanea entro minuti dall\'acquisto',
    ctaTitle: 'Pronto per Iniziare?',
    ctaSubtitle: 'Unisciti a migliaia di clienti soddisfatti oggi',
    currency: '€',
    iptvPanelTitle: 'Crediti Panel IPTV',
    iptvPanelSubtitle: 'Acquista crediti per gestire i tuoi abbonamenti IPTV con il nostro sistema di pannello avanzato',
    manageSubscriptions: 'Pacchetti di Crediti',
    perMonth: 'al mese',
    buyNow: 'Acquista Ora',
  ...
  ar: {
    ...
    heroSubtitle: 'شاهد آلاف القنوات والأفلام بجودة 4K مذهلة. استمتع بالترفيه كما لم تستمتع من قبل مع خدمة IPTV المتميزة.',
    getStarted: 'ابدأ',
    ...
    whyChooseSubtitle: 'استمتع بأفضل ما في تكنولوجيا الترفيه',
    ...
    subscriptionsTitle: 'حزم اشتراك IPTV',
    premiumQuality: 'جودة ممتازة',
    premiumQualityDesc: 'بث 4K واضح بدون انقطاع',
    guaranteedReliability: 'موثوقية مضمونة',
    guaranteedReliabilityDesc: 'ضمان وقت تشغيل 99.9% مع دعم 24/7',
    fastActivation: 'تفعيل سريع',
    fastActivationDesc: 'تفعيل فوري خلال دقائق من الشراء',
    ctaTitle: 'جاهز للبدء؟',
    ctaSubtitle: 'انضم إلى آلاف العملاء الراضين اليوم',
    currency: '$',
    iptvPanelTitle: 'نقاط لوحة IPTV',
    iptvPanelSubtitle: 'اشتر نقاط لإدارة اشتراكات IPTV الخاصة بك مع نظام اللوحة المتقدم',
    manageSubscriptions: 'حزم النقاط',
    perMonth: 'في الشهر',
    buyNow: 'اشتر الآن',

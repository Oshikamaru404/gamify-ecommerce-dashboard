          ...
          <Card>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                          ...
                          className={`p-6 rounded-lg border-2 transition-all duration-200 ${
                            selectedType === feedback.type
                              ? `${feedback.borderColor} bg-white shadow-lg scale-105`
                          ...
                          <div className="text-center">
                            ...
                            <IconComponent 
                              className={`w-8 h-8 mx-auto mb-2 ${
                                selectedType === feedback.type ? 'text-gray-700' : 'text-gray-400'
                              }`} 
                            />
                ...
                <Button
                  type="submit"
                  disabled={!selectedType || !name.trim() || !comment.trim() || createFeedback.isPending}
